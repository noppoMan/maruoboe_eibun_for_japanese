...
res.render = function(view, options, fn){
  ...
  //TODO 依存関係を何とかしたい
  var appConf = require("../../../config/appConfig");
  options.BASE_URL = appConf.get('BASE_URL');
  var vh = require("../../../core/libraries/viewHelper");

  options.helper ={}
  options.helper.link = vh.link;
  options.helper.loader = vh.loader;
