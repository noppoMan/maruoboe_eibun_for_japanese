...
if(req.host == "eng.chantake.com"){
  require(appPath + 'config/environment/production');
}
else if(req.host == "dev.eng.chantake.com"){
  require(appPath + 'config/environment/development');
}
else{
  require(appPath + 'config/environment/local');
}

if(configure.get('BASE_URL') == "SYSTEM_AUTO" || configure.get('BASE_URL') == false){
  configure.mod("BASE_URL", req.protocol + "://" + req.headers.host + "/");
}
...
if(isDynamic){
  ...
  var controller = require("../../../../routes/" + us[1]);
}
